...
#set_property -dict { PACKAGE_PIN D4    IOSTANDARD LVCMOS33 } [get_ports { sys_clock }]; #IO_L12P_T1_MRCC_35 Sch=gclk[100]
#create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports { sys_clock }];

set_property -dict {PACKAGE_PIN B5 IOSTANDARD LVCMOS33} [get_ports ULPI_clk]
create_clock -period 16.667 -name ulpi_clk_pin -waveform {0.000 8.333} -add [get_ports ULPI_clk]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets ULPI_clk]
##Quad SPI Flash
...
set_property -dict {PACKAGE_PIN D6 IOSTANDARD LVCMOS33} [get_ports ULPI_rst]
...
set_property -dict {PACKAGE_PIN J1 IOSTANDARD LVCMOS33} [get_ports {led[4]}]
set_property -dict {PACKAGE_PIN L3 IOSTANDARD LVCMOS33} [get_ports {led[5]}]
set_property -dict {PACKAGE_PIN L2 IOSTANDARD LVCMOS33} [get_ports {led[6]}]
