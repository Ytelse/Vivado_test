...
HD_PWD='/home/shomeb/u/ulrichji/Documents/dmpro/upload_test/UploadTest/UploadTest.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sw_btn_led.vds -m64 -mode batch -messageDb vivado.pb -notrace -source sw_btn_led.tcl
