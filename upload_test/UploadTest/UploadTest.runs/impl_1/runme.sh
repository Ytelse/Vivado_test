...
HD_PWD='/home/shomeb/u/ulrichji/Documents/dmpro/upload_test/UploadTest/UploadTest.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sw_btn_led.vdi -applog -m64 -messageDb vivado.pb -mode batch -source sw_btn_led.tcl -notrace
