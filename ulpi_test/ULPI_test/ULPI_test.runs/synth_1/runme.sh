...
HD_PWD='/home/shomeb/u/ulrichji/Documents/dmpro/ulpi_test/ULPI_test/ULPI_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopUlpiTest.vds -m64 -mode batch -messageDb vivado.pb -notrace -source TopUlpiTest.tcl
