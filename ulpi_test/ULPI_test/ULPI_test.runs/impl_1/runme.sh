...
HD_PWD='/home/shomeb/u/ulrichji/Documents/dmpro/ulpi_test/ULPI_test/ULPI_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TopUlpiTest.vdi -applog -m64 -messageDb vivado.pb -mode batch -source TopUlpiTest.tcl -notrace
