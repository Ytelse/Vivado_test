...
HD_PWD='/home/shomeb/u/ulrichji/Documents/dmpro/test_ebi/test_ebi.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Generator.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Generator.tcl
