...
HD_PWD='/home/shomeb/u/ulrichji/Documents/dmpro/test_ebi/test_ebi.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Generator.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Generator.tcl -notrace
